...
function onLoad() {
  ...
  // ✨ Your own custom poem here
  let customPoem = `
    You’re not the reason I breathe,<br />
    but you’re the quiet pause between my breaths.<br />
    You’re not my whole story,<br />
    but you’re the chapter my heart keeps returning to in silence.
  `;
